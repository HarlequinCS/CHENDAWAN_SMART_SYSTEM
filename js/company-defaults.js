/**
 * TEAM CHENDAWAN VENTURES — company defaults from ChendAwan.md
 */
window.TCV_COMPANY = {
  legalName: 'TEAM CHENDAWAN VENTURES',
  shortName: 'Team ChendAwan Ventures',
  tagline: 'Sole Proprietorship  ·  IT Consultancy & Services',
